...
import type { GetProductIdDto, CreateProductDto, UpdateProductDto } from "../schemas/product.schema.js";

const productSelect = { id: true, name: true, price: true, img: true, category: true, stock: true } as const;
