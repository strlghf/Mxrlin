  ...
  return (
    <header className={`main-header ${!visible ? "header-hidden" : ""}`}>
      ...
      <ul className="header-actions">
        <li>
          <Link to={"/wishlist"} className="header-action-btn" aria-label="Mis Favoritos">
        ...
        <li>
          <Link to={"/account"} className="header-action-btn" aria-label="Mi Cuenta">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <li>
          <Link to={"/cart"} className="header-action-btn header-cart-toggle" aria-label="Ver Carrito">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
